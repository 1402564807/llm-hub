...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    function handleResizeInit() {
      useResizeObserver(".llm-hub-segmented", () => {
        nextTick(() => {
      ...
      return props.options.map((option, index) => {
        return (
          ...
          >
            ...
            <div
              class="llm-hub-segmented-item-label"
              v-tippy={{
                content: option?.tip,
                zIndex: 41000
              }}
            >
              {option.icon && !isFunction(option.label) ? (
                <span
                  class="llm-hub-segmented-item-icon"
    ...
    return () => (
      <div
        class={{
          "llm-hub-segmented": true,
          "llm-hub-segmented-block": props.block,
          "llm-hub-segmented--large": props.size === "large",
          "llm-hub-segmented--small": props.size === "small"
        }}
      >
        <div class="llm-hub-segmented-group">
          <div
            class="llm-hub-segmented-item-selected"
            style={{
